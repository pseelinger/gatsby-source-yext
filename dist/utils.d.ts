...
import type { IPluginOptionsInternal, YextDoc } from "./types";
/**
...
export declare function fetchManagementApi(contentType: string, pluginOptions: IPluginOptionsInternal, pageToken?: string): Promise<any>;
